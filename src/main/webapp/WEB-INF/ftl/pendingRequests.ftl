  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>Social Network</b></a>
            <!--logo end-->
                ...
                <ul class="nav top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended tasks-bar">
                            ...
                            <li>
                                <p class="green">You have ${notificationCount} pending notifications</p>
                            </li>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
              	  ...
              	  <p class="centered"><a href="profile?personId=${user.person.pId}"><img onerror="this.src='resources/assets/img/default.jpg';" src="${user.person.profilePicPath}" class="img-circle" width="60" />
              ...
              <div class="row mtpost">
                <div class="form-panel">
                  <form:form method="GET" action="profile">
                        ...
                        <#if person.profilePicPath??><img onerror="this.src='resources/assets/img/default.jpg';" src="${person.profilePicPath}" width=150 height=150 class="img-circle" />
