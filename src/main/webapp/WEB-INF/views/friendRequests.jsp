              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li class="active"><a href="friendRequests">Friend Requests</a></li>
              ...
              <div class="row mtpost">
                <div class="form-panel">
                  <form:form method="POST" action="acceptRequest">
                        ...
                        <button type="submit" name="submitAccept" class="pull-right btn btn-primary btn-sm">Accept</button>
                        <input type="hidden" name="personId" value="${person.getpId()}" />
                        </form:form>
                        <form:form method="POST" class="pull-right" action="unFriend">
                        <button type="submit" name="submitDecline" class="btn btn-danger btn-sm">Decline</button></h3>
                        <input type="hidden" name="personId" value="${person.getpId()}" />
                  </form:form>
                </div>
              </div>
