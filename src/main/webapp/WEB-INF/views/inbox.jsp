              ...
              <div class="row">
	            ...
	            <div class="row mtpost">
	            	<c:forEach var="person" items="${personList}">
	                    <a href="getMessage?personId=${person.getpId()}"><div class="form-panel">
	                      <img onerror="this.src='resources/assets/img/default.jpg';" src="${person.getProfilePicPath()}" width=30px class="img-circle pull-left" />
	                      <h4>&nbsp; ${person.getFirstName()} ${person.getLastName()}</a></h4>
	                   </div></a>
	                </c:forEach>
	                   <!-- form-panel -->
